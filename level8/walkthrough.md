...
Dump of assembler code for function main:
   ...
   0x08048591 <+45>:    call   0x8048410 <printf@plt> ; call printf(""%p, %p \n", ptr1:DWORD PTR ds:0x8049ab0, ptr2:DWORD PTR ds:0x8049aac) 
   ...
   0x080485ae <+74>:    call   0x8048440 <fgets@plt> ; call fgets(esp+x20, 0x80, stdin)
   0x080485b3 <+79>:    test   eax,eax
   0x080485b5 <+81>:    je     0x804872c <main+456> ; IF EAX !=0
   0x080485bb <+87>:    lea    eax,[esp+0x20]
   0x080485bf <+91>:    mov    edx,eax ; eax = my user input => edx = eax
   0x080485c1 <+93>:    mov    eax,0x8048819 ; x/s 0x8048819: "auth "
   0x080485c6 <+98>:    mov    ecx,0x5
   0x080485cb <+103>:   mov    esi,edx; eax= my user input
   0x080485cd <+105>:   mov    edi,eax; eax => "auth "
   0x080485cf <+107>:   repz cmps BYTE PTR ds:[esi],BYTE PTR es:[edi]; cmp userinput  == "auth "
